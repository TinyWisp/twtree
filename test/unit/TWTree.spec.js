...
describe('select', ()=>{
    ...
    it('action: single select', async ()=>{
        ...
        await wrapper.findComponent({ref: 'node-5'}).trigger('click')
        selected = wrapper.vm.getSelected()
        selectedOne = wrapper.vm.getSelectedOne()
        expect(selected.length).toBe(1)
        expect(selectedOne).toBe(selected[0])

        await wrapper.findComponent({ref: 'node-6'}).trigger('click')
        selected = wrapper.vm.getSelected()
        selectedOne = wrapper.vm.getSelectedOne()
        expect(selected.length).toBe(1)
        expect(selectedOne).toBe(selected[0])
    ...
    it('action: multi select', async ()=>{
        ...
        await wrapper.findComponent({ref: 'node-7'}).trigger('click')
        selected = wrapper.vm.getSelected()
        selectedOne = wrapper.vm.getSelectedOne()
        expect(selected.length).toBe(3)
        expect(selectedOne).toBe(selected[0])
